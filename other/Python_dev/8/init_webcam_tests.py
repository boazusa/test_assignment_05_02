...
# Test 13: Performance, Negative, Video recording shall be be created with every supported resolution.
...
# Test 15: Negative, Video recording shall be be created with supported resolution only.
...
if __name__ == "__main__":
    ...
    video_frame_rate(device="/dev/video0", filename="video", ext="mp4")
    video_frame_rate(device="/dev/video0", filename="video", ext="avi")

    capture_image_with_different_resolution(device="/dev/video0", filename="image_12")

    video_resolution(device="/dev/video0", filename="video_13")

    capture_image_with_different_unsupported_resolution(device="/dev/video0", filename="image_14")

    video_unsupported_resolution(device="/dev/video0", filename="video_14")
