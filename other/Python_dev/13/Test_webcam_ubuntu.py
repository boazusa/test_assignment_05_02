...
# Test 12: Image capturing shall be created with every supported resolution.
...
# Test 13: Negative, Video recording shall be created with every supported resolution.
...
# Test 15: Video recording shall be created with supported resolution only.
